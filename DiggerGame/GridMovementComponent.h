...
namespace digger
{
	...
	public:
		...
		void SetCanDigDirt(bool canDig) { m_CanDigDirt = canDig; }
		void SetCanEnterDirt(bool canEnter) { m_CanEnterDirt = canEnter; }
	...
	private:
		...
		glm::ivec2 WorldPointToGrid(const glm::vec2& worldPoint) const;
		glm::ivec2 GetFrontGridPosition(const glm::vec2& worldPosition, const glm::ivec2& direction) const;

		bool CanMoveToWorldPosition(
		...
		bool m_CanDigDirt{ true };
		bool m_CanEnterDirt{ true };
		bool m_AlignToNearestGrid{};

		bool m_AligningForTurn{};
		bool m_TurnKeyHeld{};
		float m_CollisionRadius{ 31.f };
